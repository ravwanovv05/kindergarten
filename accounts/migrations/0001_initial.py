    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('user', 'User'), ('admin', 'Admin'), ('manager', 'Manager'), ('director', 'Director'), ('nursery', 'Nursery'), ('nurse', 'Nurse'), ('chef', 'Chef'), ('parent', 'Parent')], max_length=20, verbose_name='Role')),
